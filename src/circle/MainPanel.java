...
public class MainPanel extends javax.swing.JPanel
{
    ...
    {
        double h = Math.pow(2.0, - (Integer) k.getValue());
        double t = (Integer) time.getValue() * Math.PI;
        try {
    ...
    private void initComponents() {
        ...
        k.setModel(new javax.swing.SpinnerNumberModel(4, 0, 20, 1));

        jLabel2.setText("Step equals 1 / 2^K");

        jLabel3.setText("N");

        time.setModel(new javax.swing.SpinnerNumberModel(2, 1, 1000, 1));

        jLabel4.setText("Method:");

        methods.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Explicit Euler", "Incorrect Euler", "Backward Euler", "Improved Euler", "Midpoint Euler", "Trapezoidal Rule" }));
        ...
        jLabel5.setText("Time equals N * PI");
